...
class CommunityMemberFactoryTest {
    ...
    void setUp() {
        ...
        testUser = new User(3, "testuser", "hashedpassword", new java.util.Date(), new java.util.Date());
    }
    ...
    void testSave() throws SQLException {
        ...
        verify(mockConnection).executeUpdate(eq("UPDATE CommunityMembers SET Permission = ? WHERE Id = ?;"), captor.capture(), any());
