...
class CommunityFactoryTest {
  ...
  @InjectMocks private CommunityFactory communityFactory;
  ...
  void setUp() {
    ...
    testCommunity =
        new Community(
            1, "Rock Community", "A community for rock music fans", "Rock", new java.util.Date());
  }
  ...
  void testGet_CommunityFound() throws SQLException {
    ...
    Community testCommunity =
        new Community(1, "Test Community", "Description", "Genre", new java.util.Date());
