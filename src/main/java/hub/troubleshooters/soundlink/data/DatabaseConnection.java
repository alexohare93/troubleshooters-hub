...
public interface DatabaseConnection {
  /**
   * Safely executes a prepared query statement by locally initializing and disposing of the
   * database connection.
   *
   ...
   */
  <T> T executeQuery(String sql, StatementPreparer preparer, QueryExecutor<T> executor)
      throws SQLException;

  /**
   * Safely executes a prepared update statement by locally initializing and disposing of the
   * database connection.
   *
   * @param sql the unformatted SQL
   * @param preparer typically a lambda function which can add arguments to the SQL statement
   ...
   * @throws SQLException if the statement fails in some way
   */
  void executeUpdate(String sql, StatementPreparer preparer, UpdateExecutor executor)
      throws SQLException;
}
