...
/**
 * Validator class for validating the {@link RegisterModel}.
...
public class RegisterModelValidator extends ModelValidator<RegisterModel> {
    ...
    /**
     * Validates the given {@link RegisterModel} to ensure that it contains valid data.
     ...
     *
     * @param model The {@link RegisterModel} to be validated.
